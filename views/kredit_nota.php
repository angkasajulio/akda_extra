                                    ...
                                    <div class="container-fluid">
                                        <div class="card">
                                            <div class="card-header bg-success">
                                                <strong class="card-title text-light">Cetak Nota Klaim</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <table class="table table-borderless table-data3">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th><center>NILAI NOTA</center></th>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($dataklaim as $klaim) {
                                                        echo "<tr>";
                                                            ...
                                                            echo "<td>Rp ".number_format($klaim->nilai_nt)."</td>";
                                                            echo "<td>
                                                                    <center>
                                                                        <a class='btn btn-success' style='color:white;' href = '".base_url('dashboard/cetak_nota/'.$klaim->kd_cb.'/'.$klaim->kd_thn.'/'.$klaim->no_kl)."' title = 'Cetak'>Cetak</a>
                                                                    </center>
                                                                </td>";
                                                        echo "</tr>";
                                                        echo"
