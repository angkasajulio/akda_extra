                                        ...
                                        <div class="container-fluid">
                                            <div class="card">
                                                <div class="card-header bg-success">
                                                    <strong class="card-title text-light">Request Kartu</strong>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 col-lg-12">
                                                    <a style="float: right; padding-bottom: 30px;" href=<?php echo base_url('dashboard/request_kartu')?>>
                                                        <button class="btn btn-success">Request Kartu</button>
                                                    </a>
                                                </div>
                                            </div>
                                        </div>
