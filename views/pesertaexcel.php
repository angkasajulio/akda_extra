                                ...
                                <div class="row" style="min-height: 650px;">
                                    <div class="col-lg-12">
                                        <div class="card-header bg-success">
                                            <strong class="card-title text-light">Aktivasi Komunitas (Excel)</strong>
                                        </div>                                            
                                        <div class="card-header">
                                            Download Template Excel<br>
                                            <a class="btn btn-primary" href="<?php echo base_url('upload/Format Peserta Excel Akda Extra.xlsx') ?>" role="button">Disini</a>
                                        </div>
                                        <div class="card-body card-block">
                                            <form action="<?php echo base_url('dashboard/act_peserta_daftar_excel')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="file-input" class=" form-control-label">Data Excel</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="file" id="file-input" name="data_excel" class="form-control-file" onchange="getFile()">
                                                    </div>
                                                </div>
