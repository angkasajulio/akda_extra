...
<body class="animsition">
    ...
    <script>
        ...
        var status_peserta = "<?php echo $status?>";
        console.log(status_peserta);
        pagingRenewal(status_peserta);        
        ...
        function pagingRenewal(status_peserta) {
            var penampung = '';
            var counter=0;
            var page = 0;
            $.ajax({
                url: "<?php echo base_url(); ?>dashboard/next_cetak_peserta_renewal/" + status_peserta,
                method: "GET",
                async: false,
                dataType: 'json',
                success: function(data) {
