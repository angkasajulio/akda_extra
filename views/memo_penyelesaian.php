...
<head>
    ...
    <!-- Title Page-->
    <title>Memo Penyelesaian Klaim</title>
                                    ...
                                    <div class="container-fluid">
                                        <div class="card">
                                            <div class="card-header bg-success">
                                                <strong class="card-title text-light">Cetak Memo Penyelesaian Klaim</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                <tbody>
                                                    ...
                                                    foreach ($dataklaim as $klaim) {
                                                        echo "<tr>";
                                                            ...
                                                            echo "<td>
                                                                    <center>
                                                                        <a class='btn btn-success' style='color:white;' href = '".base_url('dashboard/view_klaim/'.$klaim->kd_cb.'/'.$klaim->kd_thn.'/'.$klaim->no_kl)."' title = 'Cetak'>Cetak</a>
                                                                    </center>
                                                                </td>";
                                                        echo "</tr>";
                                                        echo"
