                                        ...
                                        <div class="table-responsive m-b-40">
                                            <table class="table table-borderless table-data3">
                                                <thead>
                                                    <tr>
                                                        <center>
                                                            <th style="width: 60px;text-align:center;">Kode Role</th>
                                                ...
                                                <tbody style="display:;" id="role">
                                                    <?php foreach ($role as $role) {
                                                        echo "<tr>";
                                                            ...
                                                            echo "<td>
                                                                    <center>
                                                                        <button onclick='onDetail(" . $role->id . ")' class='btn btn-info' style='color:white;' data-toggle='modal' data-target='#detailModals'>Detail</button>
                                                                        <button onclick='onEdit(" . $role->id . ")' class='btn btn-warning' style='color:;' data-toggle='modal' data-target='#editModal'>Edit</button>
                                                                    </center>
                                                                </td>";
                                                        echo "</tr>";
                                                        }
                                            ...
                                            <div class="au-task__footer" id="btnCetak">
                                                <button class="btn btn-primary" data-toggle = 'modal' data-target = '#tambahRoleModal' style="float: right;">Tambah</button>
                                            </div>
                                        </div>
                                        <!-- END DATA TABLE-->
                                    </div>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header bg-success">
                                                        <strong class="card-title text-light">Tambah Role</strong>
                                                    </div>
                                                </div>
                                                <div class="card-body card-block">
                                                    <form action="<?php echo base_url('dashboard/act_role_tambah') ?>"
                                                        method="post" enctype="multipart/form-data"
                                                        class="form-horizontal">
                                                        <div class="row form-group">
                                                            <div class="col col-md-3">
                                                            ...
                                                            <div class="col-12 col-md-9">
                                                                <input type="text" id="roletambah" name="role"
