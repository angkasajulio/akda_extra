                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="page-content">
                                        ...
                                        <div class="container-fluid">
                                            <div class="card">
                                                <div class="card-header bg-success">
                                                    <strong class="card-title text-light">Data Master Penjualan</strong>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-12 col-lg-12">
                                                    <div class="statistic__item" id ="penjualantbl" onclick="on('penjualan','penjualanbtn','penjualantbl')" style="background-color: rgba(0, 0, 0, 0.05);">
                                                        <h2 class="number"><?php echo $jumlahpenjualan?></h2>
                                                        <span class="desc">Penjualan</span>
                                                        <div class="icon">
                                                            <i class="zmdi zmdi-account-o"></i>
                                                        </div>
                                                    </div>
                                                    <a style="float: right; padding-bottom: 30px;" href=<?php echo base_url('dashboard/tambah_penjualan')?>>
                                ...
                                <div class="row" style="min-height: 550px;">
                                    <div class="col-md-12">
                                        <input class="au-input au-input--full au-input--h65" type="text" placeholder="Cari nama komunitas" style="margin-bottom: 20px;" onkeyup="searchNama()" id="nama">
                                            ...
                                            <table class="table table-borderless table-data3">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th style="width: 170px;">NAMA MARKETING</th>
                                                        <th>AKSI</th>
                                                    </tr>
                                                </thead>
