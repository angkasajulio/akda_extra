                                ...
                                <div class="row">
                                    <div class="col-lg-12">                                            
                                        <div class="card-header bg-success">
                                            <strong class="card-title text-light">Edit Peserta</strong>
                                        </div>
                                            ...
                                            <form action="<?php echo base_url('dashboard/act_peserta_edit')?>" method="post" enctype="multipart/form-data" class="form-horizontal">
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="number" id="nopin" name="nopin" placeholder="Nomor Pin" class="form-control" value = "<?php echo $peserta[0]->nopin ?>" disabled>
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="number" id="noreg" name="noreg" placeholder="Nomor Register" class="form-control" value="<?php echo $peserta[0]->noreg ?>" disabled>
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="number" id="nonik" name="nonik" placeholder="KTP/SIM/KARTU PELAJAR/PASPOR/NRP" class="form-control" onkeyup="cekNik()" value="<?php echo $peserta[0]->no_ktp ?>">
                                                        <input type="hidden" name="id_peserta" value="<?php echo $peserta[0]->id ?>">
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="text" id="nama" name="nama" placeholder="Nama" class="form-control" onkeyup="cekNama()" value="<?php echo $peserta[0]->nama ?>">
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <textarea name="alamat" id="alamat" rows="9" placeholder="Alamat..." class="form-control" onkeyup="cekAlamat()"><?php echo $peserta[0]->alamat ?></textarea>
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="date" id="tgllahir" name="tanggallahir" placeholder="Tanggal Lahir" class="form-control" onchange="cekTglLahir()" value="<?php echo $peserta[0]->tgllahir ?>">
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="number" id="notelp" name="notelp" placeholder="Nomor Telpon" class="form-control" onkeyup="cekNoTelp()" value="0<?php echo (int)$peserta[0]->no_tlp ?>">
                                                    </div>
                                                    <input type="hidden" id="statusnotelp" value='true'>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="text-input" class=" form-control-label">TANGGAL REGISTER</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="date" id="tglregister" name="tglregister" placeholder="Tanggal Register" class="form-control" value="<?php echo $peserta[0]->tgl_reg; ?>" disabled>
                                                    </div>
                                                ...
                                                <div class="row form-group">
                                                    ...
                                                    <div class="col-12 col-md-9">
                                                        <input type="date" id="tglaktif" name="tglaktif" placeholder="tanggal expired" class="form-control" value="<?php echo $peserta[0]->tgl_aktif; ?>" disabled>
                                                    </div>
                                                    <input type="hidden" id="statustglaktif" value='true'>
                                                </div>
                                                <div class="row form-group">
                                                    <div class="col col-md-3">
                                                        <label for="text-input" class=" form-control-label">TANGGAL EXPIRED</label>
                                                    </div>
                                                    <div class="col-12 col-md-9">
                                                        <input type="date" id="tglexpired" name="tglexpired" placeholder="Tanggal Expired" class="form-control" value="<?php echo $peserta[0]->tgl_expired; ?>" disabled>
                                                    </div>
