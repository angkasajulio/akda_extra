...
<body class="animsition">
                                    ...
                                    <div class="col-md-12">
                                        <div class="card">
                                            <div class="card-header bg-success">
                                                <strong class="card-title text-light">Users</strong>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="table-responsive m-b-40">
                                            <table class="table table-borderless table-data3">
                                                <thead>
                                                    <tr>
                                                        <center>
                                                            ...
                                                            <th style="width: 130px;text-align:center;">NAMA PENGGUNA
                                                            </th>
                                                ...
                                                <tbody style="display:;" id="users">
                                                    <?php foreach ($users as $users) {
                                                        echo "<tr>";
                                                            echo "<td>".$users->email."</td>";
                                                            echo "<td>".$users->fullname."</td>";
                                                            echo "<td>".$users->posisi."</td>";
                                                            echo "<td>
                                                                    <center>
                                                                        <button onclick='onDetail(" . $users->id . ")' class='btn btn-info' style='color:white;' data-toggle='modal' data-target='#detailModals'>Detail</button>
                                                                        <button onclick='onEdit(" . $users->id . ")' class='btn btn-warning' style='color:;' data-toggle='modal' data-target='#editModal'>Edit</button>
                                                                    </center>
                                                                </td>";
                                                        echo "</tr>";
                                                        }
                                            ...
                                            <div class="au-task__footer" id="btnCetak">
                                                <button class="btn btn-primary" style="float: right;" data-toggle = 'modal' data-target='#tambahModal'>Tambah Users</button>
                                            </div>
                                        </div>
                                        <!-- END DATA TABLE-->
                                    </div>
                                    ...
                                    <div class="modal-content">
                                        <div class="modal-body">
                                            <div class="col-md-12">
                                                <div class="card">
                                                    <div class="card-header bg-success">
                                                        <strong class="card-title text-light">Tambah
                                                            User</strong>
                                                    </div>
                                                </div>
                                                <div class="card-body card-block">
                                                    <form action="<?php echo base_url('dashboard/act_users_tambah') ?>"
                                                        method="post" enctype="multipart/form-data"
                                                        class="form-horizontal">
                                                        <div class="row form-group">
                                                            <div class="col col-md-3">
                                                            ...
                                                            <div class="col-12 col-md-9">
                                                                <input type="text" id="usernametambah" name="username"
                                                                    placeholder="Username" class="form-control"
                                                                    value="">
                                                            </div>
                                                        </div>
                                                        <div class="alert alert-danger" role="alert"
                                                            style="display:none;" id="alertnamatambah">
                                                            Nama Pengguna Tidak Boleh Kosong!
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col col-md-3">
                                                            ...
                                                            <div class="col-12 col-md-9">
                                                                <input type="text" id="namatambah" name="nama"
                                                                    placeholder="Nama Pengguna" class="form-control"
                                                                    value="" onkeyup="cekNamaTambah()">
                                                            </div>
                                                            <input type="hidden" id="statusnamatambah" value='false'>
                                                        </div>
                                                        <div class="alert alert-danger" role="alert"
                                                            style="display:none;" id="alertemailtambah">
                                                            Email Tidak Boleh Kosong 
                                                        </div>
                                                        <div class="alert alert-danger" role="alert"
                                                            style="display:none;" id="alertemailsamatambah">
                                                            Email Telah digunakan
                                                        </div>
                                                        <div class="alert alert-danger" role="alert"
                                                            style="display:none;" id="alertemailformattambah">
                                                            Format email tidak sesuai
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col col-md-3">
                                                            ...
                                                            <div class="col-4 col-md-4">
                                                                <input type="text" id="emailtambah" name="email"
                                                                    placeholder="Email Pengguna"
                                                                    class="form-control" onkeyup="cekEmailTambah()" value="">
                                                                <input type="hidden" name="id_peserta" value="">
                                                            </div>
                                                            <div class="col-4 col-md-4">
                                                                @abb.co.id
                                                            </div>
                                                            <input type="hidden" id="statusemailtambah" value='false'>
                                                        </div>
                                                        <div class="alert alert-danger" role="alert"
                                                            style="display:none;" id="alertpasswordtambah">
                                                            Password tidak sesuai
                                                        </div>
                                                        <div class="alert alert-danger" role="alert"
                                                            style="display:none;" id="alertzeropasswordtambah">
                                                        ...
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-12 col-md-9">
                                                                <input type="password" id="passwordtambah" name="password"
                                                                    class="form-control"
                                                                    onkeyup="cekPasswordTambah()" value="">
                                                            </div>
                                                            <input type="hidden" id="statuspasswordtambah" value='false'>
                                                        </div>
                                                        <div class="row form-group">
                                                            <div class="col col-md-3">
                                                                <label for="text-input"
                                                            ...
                                                            <div class="col-12 col-md-9">
                                                                <input type="password" id="passwordconfirmtambah"
                                                                    class="form-control"
                                                                    onkeyup="cekPasswordTambah()" value="">
                                                            </div>
                                                        </div>
                                                        <div class="row form-group">
                                                            ...
                                                            <div class="col-12 col-md-9">
                                                                <select name="posisi" class="form-control" placeholer="Status Rekanan">
                                                                    <?php
                                                                        foreach($posisi as $posisi){
                                                                            echo '<option value="'.$posisi->id.'">'.$posisi->posisi.'</option>';
                                                                        } 
                                                                    ?>
                                                                </select>
                                                            </div>
    ...
    function cekNamaTambah(){
        var nama = document.getElementById('namatambah').value;
        if(nama==''){
            document.getElementById('statusnamatambah').value = "false";
            document.getElementById('alertnamatambah').style.display = "";
        }else{
            document.getElementById('statusnamatambah').value = "true";
            document.getElementById('alertnamatambah').style.display = "none";
        }
        activeBtnTambah();
    }

    function cekEmailTambah(){
        document.getElementById('alertemailtambah').style.display = "none";
        document.getElementById('alertemailsamatambah').style.display = "none";
        document.getElementById('alertemailformattambah').style.display = "none";
        var email = document.getElementById('emailtambah').value;
        if(email==''){
            document.getElementById('statusemailtambah').value = 'false';
            document.getElementById('alertemailtambah').style.display = "";
        }else{
            emailfix = email+"%20abb.co.id";
            $.ajax({
                url: "<?php echo base_url(); ?>dashboard/searchEmailUsers/" + emailfix,
                method: "GET",
                async: false,
                dataType: 'json',
                success: function(data) {
                    ...
                    if (data == '') {
                        ...
                        document.getElementById('alertemailsamatambah').style.display = "none";
                        document.getElementById('alertemailformattambah').style.display = "none";
                        document.getElementById('statusemailtambah').value = 'true';
                    } else {
                        document.getElementById('alertemailsamatambah').style.display = "";
                        document.getElementById('statusemailtambah').value = 'false';
                    }
                }
            });
    ...
    function cekPasswordTambah(){
        document.getElementById('alertpasswordtambah').style.display = "none";
        document.getElementById('alertzeropasswordtambah').style.display = "none";
        var password = document.getElementById('passwordtambah').value;
        var cekpassword = document.getElementById('passwordconfirmtambah').value;
        if(password == ""){
            document.getElementById('alertzeropasswordtambah').style.display = "";
            document.getElementById('statuspasswordtambah').value = "false";
        }else{
            if(password!=cekpassword){
                document.getElementById('alertpasswordtambah').style.display = "";
                document.getElementById('statuspasswordtambah').value = "false";
            }else{
                document.getElementById('statuspasswordtambah').value = "true";
            }
        }
        activeBtnTambah();
    }

    function activeBtnTambah(){
        var statusnama = document.getElementById("statusnamatambah").value;
        var statusemail = 
    }
    </script>
